      ...
      .then(stats => {
        ...
        if (this.serverless.service.package.individually) {
          ...
          functionNames.forEach(name => {
            ...
            const chunkFiles = getChunkFiles(namedChunks, handlerPath);
            const originalInclude = this.serverless.service.functions[name].include || [];
            this.serverless.service.functions[name].include = [].concat(originalInclude, ['!**'], chunkFiles);
          });
        }
